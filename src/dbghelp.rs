...
pub const SYMFLAG_FRAMEREL: ::ULONG = 0x00000020;
pub const SYMFLAG_PARAMETER: ::ULONG = 0x00000040;
pub const SYMFLAG_LOCAL: ::ULONG = 0x00000080;
pub const SYMFLAG_CONSTANT: ::ULONG = 0x00000100;
pub const SYMFLAG_EXPORT: ::ULONG = 0x00000200;
pub const SYMFLAG_FORWARDER: ::ULONG = 0x00000400;
pub const SYMFLAG_FUNCTION: ::ULONG = 0x00000800;
pub const SYMFLAG_VIRTUAL: ::ULONG = 0x00001000;
pub const SYMFLAG_THUNK: ::ULONG = 0x00002000;
pub const SYMFLAG_TLSREL: ::ULONG = 0x00004000;
pub const SYMFLAG_SLOT: ::ULONG = 0x00008000;
pub const SYMFLAG_ILREL: ::ULONG = 0x00010000;
pub const SYMFLAG_METADATA: ::ULONG = 0x00020000;
pub const SYMFLAG_CLR_TOKEN: ::ULONG = 0x00040000;
pub const SYMFLAG_NULL: ::ULONG = 0x00080000;
...
STRUCT!{struct TI_FINDCHILDREN_PARAMS {
    Count: ::ULONG,
    Start: ::ULONG,
    ChildId: [::ULONG; 1],
}}
