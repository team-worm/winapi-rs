...
pub const STILL_ACTIVE: ::DWORD = ::STATUS_PENDING as ::DWORD;
pub const EXCEPTION_ACCESS_VIOLATION: ::DWORD = ::STATUS_ACCESS_VIOLATION as ::DWORD;
pub const EXCEPTION_DATATYPE_MISALIGNMENT: ::DWORD = ::STATUS_DATATYPE_MISALIGNMENT as ::DWORD;
pub const EXCEPTION_BREAKPOINT: ::DWORD = ::STATUS_BREAKPOINT as ::DWORD;
pub const EXCEPTION_SINGLE_STEP: ::DWORD = ::STATUS_SINGLE_STEP as ::DWORD;
pub const EXCEPTION_ARRAY_BOUNDS_EXCEEDED: ::DWORD = ::STATUS_ARRAY_BOUNDS_EXCEEDED as ::DWORD;
pub const EXCEPTION_FLT_DENORMAL_OPERAND: ::DWORD = ::STATUS_FLOAT_DENORMAL_OPERAND as ::DWORD;
pub const EXCEPTION_FLT_DIVIDE_BY_ZERO: ::DWORD = ::STATUS_FLOAT_DIVIDE_BY_ZERO as ::DWORD;
pub const EXCEPTION_FLT_INEXACT_RESULT: ::DWORD = ::STATUS_FLOAT_INEXACT_RESULT as ::DWORD;
pub const EXCEPTION_FLT_INVALID_OPERATION: ::DWORD = ::STATUS_FLOAT_INVALID_OPERATION as ::DWORD;
pub const EXCEPTION_FLT_OVERFLOW: ::DWORD = ::STATUS_FLOAT_OVERFLOW as ::DWORD;
pub const EXCEPTION_FLT_STACK_CHECK: ::DWORD = ::STATUS_FLOAT_STACK_CHECK as ::DWORD;
pub const EXCEPTION_FLT_UNDERFLOW: ::DWORD = ::STATUS_FLOAT_UNDERFLOW as ::DWORD;
pub const EXCEPTION_INT_DIVIDE_BY_ZERO: ::DWORD = ::STATUS_INTEGER_DIVIDE_BY_ZERO as ::DWORD;
pub const EXCEPTION_INT_OVERFLOW: ::DWORD = ::STATUS_INTEGER_OVERFLOW as ::DWORD;
pub const EXCEPTION_PRIV_INSTRUCTION: ::DWORD = ::STATUS_PRIVILEGED_INSTRUCTION as ::DWORD;
pub const EXCEPTION_IN_PAGE_ERROR: ::DWORD = ::STATUS_IN_PAGE_ERROR as ::DWORD;
pub const EXCEPTION_ILLEGAL_INSTRUCTION: ::DWORD = ::STATUS_ILLEGAL_INSTRUCTION as ::DWORD;
pub const EXCEPTION_NONCONTINUABLE_EXCEPTION: ::DWORD = ::STATUS_NONCONTINUABLE_EXCEPTION as ::DWORD;
pub const EXCEPTION_STACK_OVERFLOW: ::DWORD = ::STATUS_STACK_OVERFLOW as ::DWORD;
pub const EXCEPTION_INVALID_DISPOSITION: ::DWORD = ::STATUS_INVALID_DISPOSITION as ::DWORD;
pub const EXCEPTION_GUARD_PAGE: ::DWORD = ::STATUS_GUARD_PAGE_VIOLATION as ::DWORD;
pub const EXCEPTION_INVALID_HANDLE: ::DWORD = ::STATUS_INVALID_HANDLE as ::DWORD;
pub const EXCEPTION_POSSIBLE_DEADLOCK: ::DWORD = ::STATUS_POSSIBLE_DEADLOCK as ::DWORD;
pub const CONTROL_C_EXIT: ::DWORD = ::STATUS_CONTROL_C_EXIT as ::DWORD;
